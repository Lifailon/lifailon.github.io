...
<p align="center">
    Веб-версия заметок по <a href="/powershell/">PowerShell</a>, командам <a href="/linux/">Linux</a> и инструментам <a href="/devops/">DevOps</a> из репозитория <a href="https://github.com/Lifailon/rudocs">ruDocs</a>, а также синтаксису <a href="/golang/">Go</a> и <a href="/node-js/">Node.js</a> на русском языке, собранные на пути от системного администратора Windows систем до DevOps инженера.
</p>

---

Пожалуйста, ознакомьтесь с другими проектами:
...
- [iPerf-GUI](https://github.com/Lifailon/iPerf-GUI) - графический интерфейс для [iperf3](https://github.com/esnet/iperf).
