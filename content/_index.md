...
<p align="center">
    Обширная база заметок по синтаксису <a href="/powershell/">PowerShell</a> и Bash, управлению <a href="/linux/">Linux</a>, инструментам <a href="/devops/">DevOps</a> и сервисам <a href="/compose/">Docker Compose</a> из репозитория <a href="https://github.com/Lifailon/rudocs">ruDocs</a>, а также синтаксису <a href="/golang/">Go</a> и <a href="/node-js/">Node.js</a> на русском языке.
</p>
...
- [iPerf-GUI](https://github.com/Lifailon/iPerf-GUI) - графический интерфейс для управления клиентом и сервером [iperf](https://github.com/esnet/iperf).
