...
- [Эффективный Go](https://github.com/0x0FACED/effective-go-ru) - актуальный перевод от сентября 2024 года.
- [Тур по Go](https://github.com/golang-ru/tour-ru) - перевод официального [тура по Go](https://go.dev/tour/welcome/1) ([исходный код](https://github.com/golang/tour)) на русский язык от 2018 года.
- [Тур по Go](https://tour.ardanlabs.com/tour/rus/list) - расширенный тур на русском языке с поддержкой выполнения кода в встроенном Playground.
- [Go в примерах](https://github.com/region23/gobyexample.ru) - исходный код для сборки [Go в примерах](https://gobyexample.ru) на русском языке (перевод от 2015 года, форк репозитория [Go by Example](https://github.com/mmcgrana/gobyexample)).
- [Введение в программирование на Go](https://github.com/maxpoletaev/golang-book) - исходный код для сборки [книги](http://golang-book.ru) (перевод книги [An Introduction to Programming in Go](https://www.golang-book.com)) от 2019 года.
- [Маленькая книга о Go](https://github.com/sefus/the-little-go-book/blob/master/ru/go.md) - перевод от 2022 года репозитория [The Little Go Book](https://github.com/karlseguin/the-little-go-book) (исходник от 2015 года).
- [Паттерны параллельного программирования Go](https://github.com/Konstantin8105/Go-pipelines) от 2018 года.
- [Гайды Uber по написанию кода на Go](https://github.com/sau00/uber-go-guide-ru) - перевод [оригинального репозитория](https://github.com/uber-go/guide) на русский язык от 2020 года.
- [Курс Golang](https://code-basics.com/ru/languages/go) от [Хекслет](https://github.com/hexlet-basics).
- [Практика GO](https://www.schoolsw3.com/go/exercise.php?filename=exercise_comments1) на упражнениях от Schoolsw3.
...
- [Шпаргалка для собеса по GoLang](https://habr.com/ru/articles/758662) на Хабр.
...
- [Go на практике](https://selectel.ru/blog/courses/practical-go) - курс от академии *Select* (8 материалов на 2 часа изучения), включающий в себя разработку REST API и gRPC сервисов.
- [Программирование на Golang](https://stepik.org/course/54403) - курсы от *Stepik* с получением сертификата (35 уроков, 64 теста и 94 задачи).
- [PRO Go. Основы программирования](https://stepik.org/course/158385) - курсы от *Stepik* с получением сертификата (38 уроков, 121 тестов и 191 задач).
- [Go - первое знакомство](https://stepik.org/course/100208) - курсы от *Stepik* с получением сертификата (42 урока, 110 тестов и 45 задач).
- [Твой Golang](https://stepik.org/course/220674) - курсы от *Stepik* с получением сертификата (154 урока, 29 часов видео, 187 тестов и 58 задач).

## Участники

Если вы нашли ошибку или хотите расширить список заметок, а также знаете другие источники для изучения, сообщите о них, внеся изменения через [Pull Requests](https://github.com/Lifailon/golang-cheat-sheet-ru/pulls).
...
| Формат    | Описание                                                                                                                                      |
| -         | -                                                                                                                                             |
| `%T`      | вывод типа данных содержимого переменной                                                                                                      |
