...
<div style="display: flex; align-items: center;">
    <img src="/Logo/node.js.png" alt="img" width="64" height="64" style="margin-right: 10px;" />
    <span>Памятка по синтаксису <b>JavaScript</b> <br> для <b>Node.js</b> в примерах.</span>
</div>
